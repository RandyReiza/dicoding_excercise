...
public class MainViewModelTest {
    ...
    public void testVolume() {
        ...
        assertEquals(dummyVolume, volume, 0.0001);  // bandingkan volume dgn dummyVolume {expected}
    }
